...
func write(type: String, point):
	...
	match type:
		"Transcipt":
			$Window/TextEdit.text = texts["Transcript"]
		"Meeting Plan":
			$Window/TextEdit.text = texts["Meeting Plan"]
		"Important Information":
			$Window/TextEdit.text = texts["Important Information"]
		"DO NOT DELETE":
			$Window/TextEdit.text = texts["DO NOT DELETE"]
		"Union Letter":
			$Window/TextEdit.text = texts["Union Letter"]
		"Contract":
			$Window/TextEdit.text = texts["Contract"]
